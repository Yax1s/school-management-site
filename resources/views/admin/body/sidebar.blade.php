        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @if(AUTH::user()->role == 'Student')
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ route('assign.subject.view.student') }}"><i class="ti-more"></i>Subject Details</a>
                        </li>
            ...
            @if(Auth::user()->role == 'Student')
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ route('registration.fee.singular.view') }}"><i class="ti-more"></i>Registration
                                Fee </a></li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ ($route == 'marksheet.generate.view')?'active':'' }}"><a
                                href="{{ route('marksheet.generate.view') }}"><i class="ti-more"></i>MarkSheet Generate</a>
                        </li>
            ...
            @if(Auth::user()->role == 'Student')
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ ($route == 'marksheet.generate.singular.view')?'active':'' }}"><a
                                href="{{ route('marksheet.generate.singular.view') }}"><i class="ti-more"></i>MarkSheet
                                Generate</a></li>

                        <li class="{{ ($route == 'student.singular.idcard.view')?'active':'' }}"><a
                                href="{{ route('student.singular.idcard.view') }}"><i class="ti-more"></i>Student ID
                                Card </a></li>
